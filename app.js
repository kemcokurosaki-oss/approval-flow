...
const SHEET_ITEM_GROUPS = [
    { group: '組立作業確認', items: [
        { id: '1',  text: 'Iマークは全てのボルトに付けられているか？' },
        { id: '2',  text: '必要な場所に油を塗布しているか？' },
        { id: '3',  text: '必要な場所にグリスを充填しているか？' },
        { id: '4',  text: 'グリスニップル口の向きは適切か？' },
    ]},
    { group: '干渉チェック', items: [
        { id: '5',  text: 'グリスニップルが回転軸・ハンドル等に干渉しないか？' },
        { id: '6',  text: '可動部と固定部の干渉箇所はないか？' },
    ]},
    { group: '動作確認', items: [
        { id: '7',  text: 'ハンドルはスムーズに回るか？' },
        { id: '8',  text: 'その他回転物はスムーズに回るか？' },
        { id: '9',  text: 'モーターは問題なく作動するか？' },
        { id: '10', text: '空圧シリンダーはスムーズに動くか？' },
        { id: '11', text: '油圧シリンダーはスムーズに動くか？' },
        { id: '12', text: 'クーラント経路をエアーで確認したか？' },
    ]},
    { group: '数値調整', items: [
        { id: '13', text: 'デジタルカウンターの数値はあっているか？' },
        { id: '14', text: '通り芯は公差内に収まっていたか？（ミルの場合）' },
        { id: '15', text: '組図によるストロークチェックはしたか？' },
        { id: '16', text: '組図に指定のある各種設定値は公差内に収まっているか？' },
    ]},
    { group: '外観チェック', items: [
        { id: '18', text: '塗装色は社内製作仕様書と一致しているか？' },
        { id: '19', text: '塗装が必要なすべての場所に塗装しているか？' },
        { id: '20', text: '塗装が剥げている箇所はないか？' },
        { id: '21', text: 'キズ・凹みなどないか？' },
        { id: '22', text: '錆はないか？' },
    ]},
    { group: '据付用', items: [
        { id: '23', text: '据付水平基準マークはあるか？' },
        { id: '24', text: '据付センター基準線は入っているか？' },
        { id: '25', text: '据付面（機械底面）に塗装していないか？' },
    ]},
    { group: 'シール・銘板', items: [
        { id: '26', text: 'グリスシールは全て貼り付けたか？' },
        { id: '27', text: '回転シールは全て貼り付けたか？' },
        { id: '28', text: '社銘板・オーダー銘板は付いているか？' },
        { id: '29', text: '空圧ゲージの銘板はあるか？' },
        { id: '30', text: '油圧ゲージの銘板はあるか？' },
        { id: '31', text: 'センサーの銘板はあるか？' },
        { id: '32', text: 'ベンディングリストは取り付けたか？' },
    ]},
    { group: '外観検査準備', items: [
